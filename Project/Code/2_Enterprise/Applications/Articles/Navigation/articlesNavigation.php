	...
	public function getNavigationListAsArray()
	{
		...
		foreach($this->categories as $category)
		{
			...
			<li class="mTxl clearfix '.$this->active.'">
				...
				<span class="sprite addSubCategory pointer mTxs" id="add_category">
					<input type="hidden" name="category_id" value="'.$category_id.'">
				</span><br>
				
				<span class="sprite addArticle pointer" id="add_product">
					<input type="hidden" name="category_id" value="'.$category_id.'">
				</span>
		...
		if(strlen($category_li) == 0)
			return '
				<div class="pTl pLl pRl" id="heading">
					...
					<span class="sprite addArticle pointer" id="add_product"></span>
				</div>
